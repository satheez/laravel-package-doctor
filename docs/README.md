# Laravel Package Doctor — Documentation

Full reference documentation for `satheez/laravel-package-doctor`.

## Contents

| Document | Description |
|---|---|
| [Installation](installation.md) | Requirements, install steps, GitHub token setup |
| [Usage](usage.md) | Every CLI flag with examples and worked scenarios |
